    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 xl:grid-cols-2">
        <form className="card grid gap-4 p-5" onSubmit={handleSubmit(() => {})}>
          <div className="flex items-center gap-3"><FaUserShield className="text-fundsphere-blue" /><h2 className="section-title">User Details</h2></div>
        ...
        <section className="card grid gap-4 p-5">
          <div className="flex items-center gap-3"><FaKey className="text-fundsphere-blue" /><h2 className="section-title">Security</h2></div>
      ...
      <section className="card p-5">
        <div className="flex items-center gap-3"><FaPhoneAlt className="text-fundsphere-red" /><h2 className="section-title">Emergency Access</h2></div>
